...
addon = xbmcaddon.Addon(id='plugin.video.BlurayPlay3.0')
...
off1  =  "=wWb45ibpFWbv8yUCFkVP50LpR2br9SbvNmL5FGbwlXYyVWdsJ2LvoDc0RHa"
...
def SKindex():
    ...
    getData(off,'')
    msg2 = "https://pastebin.com/raw/XPKNmf2A"				
    msg = msg2 
